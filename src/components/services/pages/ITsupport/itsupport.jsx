...
const services = [
  {
    ...
    description: `
      Managed IT services provide businesses with comprehensive support to oversee and manage their IT infrastructure, including network monitoring, troubleshooting, and managing cloud services. By outsourcing IT operations to a reliable provider, businesses can reduce downtime, improve system performance, and stay ahead of the latest technology trends without needing in-house staff to handle these areas. This service offers a complete package of IT management that helps businesses run smoothly and effectively.
  ...
  },
  {
    ...
    description: `
      Remote technical support provides businesses with the ability to get quick help without needing to have IT technicians visit their physical location. Technicians can remotely diagnose and resolve issues using secure remote tools, allowing them to access and fix devices, software, and networks in real-time. This service ensures minimal disruption to daily operations, as IT issues can be resolved promptly without the need for on-site visits.
